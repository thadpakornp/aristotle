        ...
        <nav class="navbar-mobile">
            <div class="container-fluid">
                <ul class="navbar-mobile__list list-unstyled">
                    <li>
                        <a href="">
                            <i class="far fa-check-square"></i>Create channel</a>
                    </li>
                    @role('admin')
                    <li class="has-sub">
...
{{--                                </div>--}}
                            ...
                            <div class="account-wrap">
                                <div class="account-item clearfix js-item-menu">
                                    <div class="image">
                                        <img src="@if(auth()->user()->profile == null) {{ asset('images/icon/avatar-01.jpg') }} @else {{ asset(auth()->user()->profile) }} @endif" alt="{{ auth()->user()->name }} {{ auth()->user()->surname }}" />
                                    </div>
                                    <div class="content">
                                        <a class="js-acc-btn" href="#">{{ auth()->user()->name }} {{ auth()->user()->surname }}</a>
                                    </div>
